 ...
 ******************************************************************************
 */
#define __RTC_PRESCALER					64
#define __CLOCK_DIVISOR					((uint32_t)RTC_CLOCK_FREQ * (uint32_t)RTC_INTERRUPT_PRESCALER * (uint32_t)__RTC_PRESCALER)
#define __TIMER_COUNT					(uint8_t)((F_CPU / __CLOCK_DIVISOR) - 1)
/*
 ******************************************************************************
 */
